...
public class LocationQueryServiceTests {
    ...
    @Autowired
    private MockRestServiceServer mockRestServiceServer; // fake server - stands in place of the actual server

    @Autowired // autowiring that this is what we want to test
